...
function js_hps_settings_init(  ) { 
	...
	register_setting( 'pluginPage', 'js_hps_settings', 'js_hps_sanitize_options' );
...
function js_hps_sanitize_options($input) {
    ...
    return apply_filters( 'js_hps_sanitize_options', $output, $input );
